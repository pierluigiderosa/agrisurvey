# -*- coding: utf-8 -*-
# Generated by Django 1.11.23 on 2019-12-10 07:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pec', models.EmailField(blank=True, max_length=254, null=True, verbose_name='Email PEC:')),
                ...
                ('biologica', models.NullBooleanField(verbose_name='Azienda biologica')),
                ('iban', django_iban.fields.IBANField(blank=True, default='', enforce_database_constraint=False, help_text='Iban per eventuale risarcimento', max_length=34, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_danno', models.DateField(blank=True, null=True, verbose_name='data del danno')),
                ...
                ('TipoPiante', models.CharField(blank=True, help_text="et\xe0 dell'impianto, altezza, caratteristiche se vivaio, ecc.", max_length=50, verbose_name='Tipologia di piante oggetto di danneggiamento')),
                ...
                ('polizza', models.NullBooleanField(verbose_name='Polizza assicurativa')),
                ('biologica', models.NullBooleanField(verbose_name='Azienda biologica')),
                ('iban', django_iban.fields.IBANField(blank=True, default='', enforce_database_constraint=False, help_text='Iban ', max_length=34, null=True)),
                ...
                ('fog_part_db', models.ManyToManyField(help_text='Inserire nel formato Comune foglio e particella del tipo : -<b>Empoli 060 317</b>- dove 060 \xe8 il foglio \xe8 60 e 317 la particella', to='domanda.catastale_new', verbose_name='Foglio Particella da Catastale')),
        ...
        migrations.CreateModel(
            name='quandranti_livorno',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location', models.CharField(max_length=254)),
                ('num', models.BigIntegerField()),
                ('geom', django.contrib.gis.db.models.fields.MultiPolygonField(srid=3003)),
            ],
        ),
    ]
